    ...
    const response = await fetch('https://api.openai.com/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: `You are a professional real estate agent assistant. Generate a friendly, personalized WhatsApp message for a lead. 
...
- Be helpful and genuine`
          ...
          { 
            role: 'user', 
            content: `Generate a WhatsApp response for this lead:
