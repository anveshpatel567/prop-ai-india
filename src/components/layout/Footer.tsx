        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-accent-blue font-bold text-lg">FreePropList</span>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <p className="text-text-muted text-sm font-dmsans">Email: info@freeproplist.com</p>
              <p className="text-text-muted text-sm font-dmsans">Phone: 95129 01356</p>
              <p className="text-text-muted text-sm font-dmsans">
