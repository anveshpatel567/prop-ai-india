...
export const FireIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
  <svg className={className} fill="currentColor" viewBox="0 0 24 24">
    <path d="M12 2C8.686 2 6 4.686 6 8c0 4.5 3.206 6.895 6 9.5C14.794 14.895 18 12.5 18 8c0-3.314-2.686-6-6-6zm0 3c1.657 0 3 1.343 3 3s-1.343 3-3 3-3-1.343-3-3 1.343-3 3-3z" />
  </svg>
);
